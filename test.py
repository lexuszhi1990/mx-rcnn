...
def parse_args():
    ...
    # testing
    parser.add_argument('--prefix', help='model to test with', default=config.e2e_prefix, type=str)
    parser.add_argument('--epoch', help='model to test with', default=config.e2e_epoch, type=int)
    parser.add_argument('--gpus', help='GPU device to test with', default=0, type=int)
    # rcnn
